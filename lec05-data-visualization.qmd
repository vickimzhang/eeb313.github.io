...
# read file into R
portal_data <- read_csv(here('1_lectures/csv/portal_data.csv'))
...
write.csv(surveys_subset,
          file = here("1_lectures/csv/survey_subset.csv"))

# if you already have surveys_subset.csv in your file folder, you only have to run this
surveys_subset <- read_csv(here('1_lectures/csv/survey_subset.csv'))

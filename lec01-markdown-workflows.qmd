---
title: "Markdown, project workflows"
output: md_document
urlcolor: blue
editor_options: 
  markdown: 
...
-   Perhaps the most important folder is `analyses` or `scripts`. Here,
    ...
    better to keep them in this folder as well. There is also an
...
- [Contributor
Convenent](https://www.contributor-covenant.org/version/1/4/code-of-conduct/)
- [UofT Coders Code of
...
If we run out of time to do this in lecture 1, do click-and-drag here.
